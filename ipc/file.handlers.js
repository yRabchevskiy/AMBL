...
exports.initFileHandlers = initFileHandlers;
const electron_1 = require("electron");
const fs = __importStar(require("fs"));
const path = __importStar(require("path"));
function initFileHandlers() {
    // 1. Вибір папки
    electron_1.ipcMain.handle('select-folder', () => __awaiter(this, void 0, void 0, function* () {
    ...
    // 2. Читання вмісту
    electron_1.ipcMain.handle('read-directory', (event, folderPath) => __awaiter(this, void 0, void 0, function* () {
        try {
